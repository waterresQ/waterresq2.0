...
class Admincommunitychat extends StatefulWidget {
  Admincommunitychat(
  ...
  String phone;
  @override
  State<Admincommunitychat> createState() => _communitychatState();
}

class _communitychatState extends State<Admincommunitychat> {
  final _database =
